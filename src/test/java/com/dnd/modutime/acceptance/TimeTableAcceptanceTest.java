    ...
    void v2_특정_참여자의_시간만_조회한다() {
        ...
        assertAll(
                ...
                () -> {
                    var _02_08 = timeAndCountPerDates.get(0);
                    assertThat(_02_08.getAvailableDate()).isEqualTo(_2023_02_08);
                    assertThat(_02_08.getAvailableTimeInfos()).hasSize(3);
                    assertThat(_02_08.getAvailableTimeInfos()).extracting("time")
                            .containsExactlyInAnyOrder(_11_00, _11_30, _13_00);
                },
                () -> {
                    var _02_09 = timeAndCountPerDates.get(1);
                    assertThat(_02_09.getAvailableDate()).isEqualTo(_2023_02_09);
                    assertThat(_02_09.getAvailableTimeInfos()).hasSize(3);
                    assertThat(_02_09.getAvailableTimeInfos()).extracting("time")
                            .containsExactlyInAnyOrder(_11_00, _11_30, _13_00);
                },
                () -> {
                    var _02_10 = timeAndCountPerDates.get(2);
                    assertThat(_02_10.getAvailableDate()).isEqualTo(_2023_02_10);
                    assertThat(_02_10.getAvailableTimeInfos()).hasSize(3);
                    assertThat(_02_10.getAvailableTimeInfos()).extracting("time")
                            .containsExactlyInAnyOrder(_11_00, _11_30, _13_00);
                }
        );
    ...
    void v2_여러_참여자의_시간만_조회한다() {
        ...
        assertAll(
                ...
                () -> {
                    var _02_08 = timeAndCountPerDates.get(0);
                    assertThat(_02_08.getAvailableDate()).isEqualTo(_2023_02_08);
                    assertThat(_02_08.getAvailableTimeInfos()).hasSize(5);
                    assertThat(_02_08.getAvailableTimeInfos()).extracting("time")
                            .containsExactlyInAnyOrder(_11_00, _11_30, _12_00, _12_30, _13_00);
                },
                () -> {
                    var _02_09 = timeAndCountPerDates.get(1);
                    assertThat(_02_09.getAvailableDate()).isEqualTo(_2023_02_09);
                    assertThat(_02_09.getAvailableTimeInfos()).hasSize(4);
                    assertThat(_02_09.getAvailableTimeInfos()).extracting("time")
                            .containsExactlyInAnyOrder(_11_00, _11_30, _13_00, _13_30);
                },
                () -> {
                    var _02_10 = timeAndCountPerDates.get(2);
                    assertThat(_02_10.getAvailableDate()).isEqualTo(_2023_02_10);
                    assertThat(_02_10.getAvailableTimeInfos()).hasSize(5);
                    assertThat(_02_10.getAvailableTimeInfos()).extracting("time")
                            .containsExactlyInAnyOrder(_11_00, _11_30, _12_30, _13_00, _13_30);
                }
        );
    }
