...
import com.dnd.modutime.core.timetable.controller.TimeTableQueryController;
...
@ApiDocsTest
public class TimeTableQueryControllerDocsTest {

    @Mock
    private TimeTableFacade facade;

    @InjectMocks
    private TimeTableQueryController controller;

    @DisplayName("실시간 참여 현황 조회 API")
    @Test
    void test01(RestDocumentationContextProvider contextProvider) throws Exception {
        var operationIdentifier = "get-api-room-room-uuid-available-time-overview";
        ...
        MockMvcFactory.getRestDocsMockMvc(contextProvider, LOCALHOST, controller)
                .perform(
                        get("/api/room/{roomUuid}/available-time/overview", "test-room-uuid")
                        ...
                        MockMvcRestDocumentationWrapper.document(
                                ...
                                ResourceDocumentation.resource(
                                        ResourceSnippetParameters.builder()
                                                .description("참여자별 실시간 참여 현황 조회 API")
                                                .tag("TimeTable")
