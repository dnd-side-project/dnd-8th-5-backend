...
public class AdjustmentResultReplaceService {
    ...
    public void replace(TimeTableReplaceEvent event) {
        ...
        List<CandidateDateTimeDto> candidateDateTimesDto = candidateDateTimeConvertor.convert(event.getDateInfos());
        List<CandidateDateTime> candidateDateTimes = candidateDateTimesDto.stream()
                .map(candidateDateTimeDto -> new CandidateDateTime(
                        adjustmentResult,
                        candidateDateTimeDto.getDate(),
                        candidateDateTimeDto.getStartTime(),
                        candidateDateTimeDto.getEndTime(),
                        false,
                        candidateDateTimeDto.getParticipantNames().stream()
