...
public class AdjustmentResultReplaceService {
    ...
    public void replace(TimeTableReplaceEvent event) {
        ...
        candidateDateTimes.forEach(candidateDateTime -> candidateDateTime.setAdjustmentResult(adjustmentResult));
...
//                        adjustmentResult,
//                        candidateDateTimeDto.getStartDateTime(),
//                        candidateDateTimeDto.getEndDateTime(),
//                        false,
