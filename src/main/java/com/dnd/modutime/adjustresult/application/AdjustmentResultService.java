...
import com.dnd.modutime.room.application.AdjustmentResultExecutorFactory;
...
public class AdjustmentResultService {
    ...
    public AdjustmentResultResponse getByRoomUuidAndSortedAndNames(String roomUuid,
        ...
        CandidateDateTimeResultExecutor candidateDateTimeResultExecutor = adjustmentResultExecutorFactory.getInstance(roomUuid, names);
        List<CandidateDateTimeDto> candidateDateTimesDto = candidateDateTimeResultExecutor.execute(roomUuid, SortedBy.valueOf(sorted), names);
